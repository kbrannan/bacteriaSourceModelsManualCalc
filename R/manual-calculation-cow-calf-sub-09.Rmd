...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 09"
...
```{r}
num.Pasture.Area <- 53
num.Forest.Area <- 2973.5
num.Percent.pasture.with.stream.access <- 7.0000000E+00
num.Percent.forest.with.stream.access <- 1.6094129E+00
```
