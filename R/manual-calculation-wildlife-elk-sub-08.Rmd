...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk08.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 10.41
num.season.1.forest.hab.area  <- 275.26
num.season.2.pasture.hab.area <- 0.07
num.season.2.forest.hab.area  <- 38.2
```
