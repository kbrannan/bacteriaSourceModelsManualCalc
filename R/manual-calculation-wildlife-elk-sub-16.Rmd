...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk16.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 12.48
num.season.1.forest.hab.area  <- 198.09
num.season.2.pasture.hab.area <- 0.66
num.season.2.forest.hab.area  <- 14.67
```
