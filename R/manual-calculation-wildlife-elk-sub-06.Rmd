...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk06.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 13.29
num.season.1.forest.hab.area  <- 181.51
num.season.2.pasture.hab.area <- 0
num.season.2.forest.hab.area  <- 299.17
```
