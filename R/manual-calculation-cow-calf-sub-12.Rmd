...
```
## Input Data
Values taken from Cow-Calf Bacteria Source Model Input File: cowcalf12.txt
### Land Use Information (ac)
```{r}
num.Pasture.Area <- 8.7
num.Forest.Area <- 1117.9
num.Percent.pasture.with.stream.access <- 5.2715915E+01
num.Percent.forest.with.stream.access <- 1.0121110E+00
```
