...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 11"
chr.DateInputFileCreated <- "2013-05-10"
chr.sub.cur <- gsub("[^0-9]","",chr.watershed)
```
## Input Data
Values taken from Cow-Calf Bacteria Source Model Input File: cowcalf11.txt
### Land Use Information (ac)
```{r}
num.Pasture.Area <- 92.5
num.Forest.Area <- 3916.2
num.Percent.pasture.with.stream.access <- 7.7174911E+00
num.Percent.forest.with.stream.access <- 2.1986574E-01
```
