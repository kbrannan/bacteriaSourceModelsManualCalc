...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk11.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 8.02
num.season.1.forest.hab.area  <- 273.73
num.season.2.pasture.hab.area <- 0
num.season.2.forest.hab.area  <- 10.35
```
