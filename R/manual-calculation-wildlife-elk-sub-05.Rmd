...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk05.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 10.37
num.season.1.forest.hab.area  <- 18.74
num.season.2.pasture.hab.area <- 0
num.season.2.forest.hab.area  <- 0.39
```
