...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk04.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 11.34
num.season.1.forest.hab.area  <- 174.04
num.season.2.pasture.hab.area <- 6.06
num.season.2.forest.hab.area  <- 236.17
```
