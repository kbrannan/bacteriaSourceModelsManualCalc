...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 05"
...
```{r}
num.Pasture.Area <- 112.8
num.Forest.Area <- 228.2
num.Percent.pasture.with.stream.access <- 6.1000000E+01
num.Percent.forest.with.stream.access <- 1.6517286E-02
```
