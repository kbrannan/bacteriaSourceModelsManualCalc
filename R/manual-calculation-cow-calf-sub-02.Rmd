...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 02"
...
```{r}
num.Pasture.Area <- 324.9
num.Forest.Area <- 6308.4
num.Percent.pasture.with.stream.access <- 1.9233492E+01
num.Percent.forest.with.stream.access <- 4.3426000E-03
```
