...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 17"
...
```{r}
num.Pasture.Area <- 197.5
num.Forest.Area <- 828
num.Percent.pasture.with.stream.access <- 4.9000000E+01
num.Percent.forest.with.stream.access <- 2.1832975E-01
```
