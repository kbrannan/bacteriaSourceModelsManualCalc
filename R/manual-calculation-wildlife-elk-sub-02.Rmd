...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk02.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 25.89
num.season.1.forest.hab.area  <- 371.53
num.season.2.pasture.hab.area <- 2.74
num.season.2.forest.hab.area  <- 122.5
```
