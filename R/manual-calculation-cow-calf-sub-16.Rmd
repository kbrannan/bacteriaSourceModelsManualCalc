...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 16"
chr.DateInputFileCreated <- "2013-05-10"
chr.sub.cur <- gsub("[^0-9]","",chr.watershed)
```
## Input Data
Values taken from Cow-Calf Bacteria Source Model Input File: cowcalf16.txt
### Land Use Information (ac)
```{r}
num.Pasture.Area <- 150.8
num.Forest.Area <- 2767.1
num.Percent.pasture.with.stream.access <- 3.2000000E+01
num.Percent.forest.with.stream.access <- 5.1583584E-01
```
