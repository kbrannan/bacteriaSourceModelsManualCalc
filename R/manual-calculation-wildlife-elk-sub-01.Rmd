...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk01.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 33.94
num.season.1.forest.hab.area  <- 529.58
num.season.2.pasture.hab.area <- 6.0
num.season.2.forest.hab.area  <- 198.39
```
