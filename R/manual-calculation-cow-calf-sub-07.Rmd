...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 07"
...
```{r}
num.Pasture.Area <- 185.5
num.Forest.Area <- 627.2
num.Percent.pasture.with.stream.access <- 7.1000000E+01
num.Percent.forest.with.stream.access <- 3.2649010E-02
```
