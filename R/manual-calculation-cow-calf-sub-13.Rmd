...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 13"
chr.DateInputFileCreated <- "2013-05-10"
chr.sub.cur <- gsub("[^0-9]","",chr.watershed)
```
## Input Data
Values taken from Cow-Calf Bacteria Source Model Input File: cowcalf13.txt
### Land Use Information (ac)
```{r}
num.Pasture.Area <- 475.9
num.Forest.Area <- 4882.5
num.Percent.pasture.with.stream.access <- 2.5000000E+01
num.Percent.forest.with.stream.access <- 1.8902330E-01
```
