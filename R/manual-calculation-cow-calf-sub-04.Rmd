...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 04"
...
```{r}
num.Pasture.Area <- 195.2
num.Forest.Area <- 4868.1
num.Percent.pasture.with.stream.access <- 3.2074909E+01
num.Percent.forest.with.stream.access <- 7.2642000E-04
```
