...
```{r}
chr.watershed <- "Big Elk Creek Sub-Wtsd 01"
chr.DateInputFileCreated <- "2016-05-04"
...
```{r}
num.Pasture.Area <- 445.3
num.Forest.Area <- 8739.8
num.Percent.pasture.with.stream.access <- 4.8000000E+01
num.Percent.forest.with.stream.access <- 3.7235884E+01
```
...
chr.dir.main <- "M:/Models/Bacteria/HSPF/bacteriaSourceModelsTesting"
chr.dir.input <- paste0(chr.dir.main, "/model-input-tpl-txt/cow-calf")
