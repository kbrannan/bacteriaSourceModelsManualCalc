...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk07.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 17.09
num.season.1.forest.hab.area  <- 55.66
num.season.2.pasture.hab.area <- 0
num.season.2.forest.hab.area  <- 0
```
