...
```
## Input Data
Values taken from Onsite-Pets Bacteria Source Model Input File: wildlifeElk09.txt
### Months of seasons
```{r}
...
### Habitat areas(ac.)
```{r}
num.season.1.pasture.hab.area <- 4.59
num.season.1.forest.hab.area  <- 234.33
num.season.2.pasture.hab.area <- 0
num.season.2.forest.hab.area  <- 25.63
```
